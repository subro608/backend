...
urlpatterns = [
    ...
    path("verify/generatenew/", csrf_exempt(VerifyEmailView.generate_new_link), name="verify-email-regenerate"),
    path("login/", LoginView.as_view(), name="login"),
    path("lessee_setup/", LesseeSetupView.as_view(), name="lessee-setup"),
    path("lessee_setup/<uuid:pk>/", LesseeSetupView.as_view(), name="lessee-setup-detail"),
